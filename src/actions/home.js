...
export const showMoviesAsync = createActionAsync(SHOW_MOVIES_ASYNC, () => request({ url: 'https://raw.githubusercontent.com/facebook/react-native/master/docs/MoviesExample.json' }), 'movies');
